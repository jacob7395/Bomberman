...
class AIBot :
    ...
    def update(self, currentPosition, display) :
        if self.path is not None :
            if self.isRunning == False :
                targetPosition = [self.path[-1][0] * 34, self.path[-1][1] * 34]
                if targetPosition is not currentPosition :
                    ...
                    pygame.draw.rect(display, (150, 0, 0), rec2);
                    pygame.draw.rect(display, (0, 150, 0), rec1);
