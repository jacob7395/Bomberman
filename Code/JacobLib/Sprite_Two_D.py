...
class Sprite_Two_Dimensions(pygame.sprite.Sprite):
    ...
    def get_Collision_Coners(self):
        pos = self.Position()
        cornors = []
        cornors.append((pos[0] + self.collition_Offset, pos[1] + self.collition_Offset))
        cornors.append((pos[0] + self.collition_Offset, pos[1] + (self.scale - self.collition_Offset)))
        cornors.append((pos[0] + (self.scale - self.collition_Offset), pos[1] + self.collition_Offset))
        cornors.append((pos[0] + (self.scale - self.collition_Offset), pos[1] + (self.scale - self.collition_Offset)))
        return cornors
