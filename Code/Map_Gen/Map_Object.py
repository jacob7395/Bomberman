    ...
    def __init__(self, grid, size=16, grid_Start_Position=0):
        ...
        for row in grid:
            ...
            for character in row:
                ...
                self.map_Grid[x].append({"Tile": character, "Position": (size * x, size * y), "Movable": self.tile_Dic[character], "C_Aare": (size, size), "Bomb": False, "Bomb_Object": None, "Bomb_Object": None})
                x += 1
            y += 1
